...
help:
	...
	@echo "  update-check : Check available updates for WordPress core, plugins, and themes"
	@echo "  update-core  : Update WordPress core"
	@echo "  update-plugins: Update all WordPress plugins"
	@echo "  update-themes: Update all WordPress themes"
	@echo "  versions     : Display current versions of WordPress core, plugins, and themes"
	@echo ""
	@echo "Available services for exec and shell commands:"
	@echo "  - wp         : WordPress container"
	@echo "  - db         : Database container"
	@echo "  - mailpit    : Mail testing container"
	@echo "  - phpmyadmin : phpMyAdmin container"
